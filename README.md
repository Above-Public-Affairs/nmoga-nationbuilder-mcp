...
additionally shows your own record. From inside a chat, the `connection_status`
tool reports the same thing for your own session — no HTTP credential needed,
it goes through the same session auth as any other tool call.
